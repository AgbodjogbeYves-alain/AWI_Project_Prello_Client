        ...
        <ul className="navbar-nav align-items-lg-center ml-lg-auto navbar-nav-hover">
          ...
          <li>
            <a className="nav-link notifications" href="#" >
              <i className="ni ni-bell-55 ni-lg" />
              ...
              <div className="row">
                <div className="col-6 collapse-brand">
                  <Link to={user ? '/dashboard' : '/'}>
                    <img src="https://rawcdn.githack.com/AgbodjogbeYves-alain/AWI_Project_Prello_Client/61533a294565a4118be8afff4ec82c896286f5e1/public/assets/img/brand/blue.png" />
                  </Link>
                </div>
